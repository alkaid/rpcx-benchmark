...
func main() {
	...
	cfg.Set("pitaya.cluster.rpc.server.nats.buffer.messages", 1000000)
	...
	app, bs, _ := createApp("protobuf", port, *grpc, *isFrontend, "natssvr", pitaya.Cluster, map[string]string{
